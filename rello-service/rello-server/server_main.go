...
func main() {
	...
	*/
	...
	{
		//checklistwebhookDuration := duration.With(metrics.Field{Key: "method", Value: "CheckListWebhook})"
		//checklistwebhookLogger := log.NewContext(logger).With("method", "CheckListWebhook)")

		checklistwebhookEndpoint = svc.MakeCheckListWebhookEndpoint(service)
		//checklistwebhookEndpoint = opentracing.TraceServer(tracer, "CheckListWebhook)")(checklistwebhookEndpoint)
		//checklistwebhookEndpoint = svc.EndpointInstrumentingMiddleware(checklistwebhookDuration)(checklistwebhookEndpoint)
		//checklistwebhookEndpoint = svc.EndpointLoggingMiddleware(checklistwebhookLogger)(checklistwebhookEndpoint)
	}
